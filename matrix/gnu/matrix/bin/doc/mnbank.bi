...
S in a given vector space, S ? (C 0 )0 . We generally write (C 0 )0 as just C 00 .
(The precise notation of course is C 0 (C 0 (S)).) We see this by ?rst taking
any v ? S. Therefore, if v 0 ? C 0 then v, v 0  = 0, which implies v ? (C 0 )0 ,
because
C 00 = {v s.t. v, v 0  = 0 for all v 0 ? C 0 }.
==============================================================================='/
#ifdef PropertyVectors
#macro Polar ( sivc1, sivc2, sivc3 )
declare sub Polar ( )
